...
+ 29.10.2025
  1. Выполнение задания 8 "Сортировка пузырьком" и загрузка в данный репозиторий.
+ 13.11.2025
  1. Выполнение задания 9 "Сортировка вставками" и загрузка в данный репозиторий.
